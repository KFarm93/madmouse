...
function whichMaze() {
  ...
  if (num === 1) {
    ...
    return [ // Row A
                  ...
                  // Row E
                  [{up: false, right: false, down: true, left: true, name: 'E1'}, {up: false, right: true, down: true, left: false, name: 'E2'}, {up: false, right: false, down: true, left: true, name: 'E3'}, {up: false, right: false, down: true, left: false, name: 'E4'}, {up: true, right: true, down: false, left: false, name: 'E5'}, {up: true, right: false, down: false, left: true, name: 'E6'}, {up: true, right: true, down: false, left: false, name: 'E7'}, {up: false, right: true, down: false, left: true, name: 'E8'}, {up: false, right: true, down: false, left: true, name: 'E9'}, {up: false, right: true, down: false, left: true, name: 'E10'}, {up: false, right: true, down: false, left: true, name: 'E11'}, {up: false, right: true, down: false, left: true, name: 'E12'}, {up: true, right: false, down: true, left: true, name: 'E13'}, {up: false, right: true, down: false, left: true, name: 'E14'}],
                  // Row F
                  ...
                  // Row L
                  [{up: false, right: false, down: true, left: true, name: 'L1'}, {up: true, right: false, down: true, left: false, name: 'L2'}, {up: true, right: false, down: true, left: false, name: 'L3'}, {up: false, right: true, down: false, left: false, name: 'L4'}, {up: false, right: false, down: true, left: true, name: 'L5'}, {up: true, right: false, down: true, left: false, name: 'L6'}, {up: true, right: true, down: false, left: false, name: 'L7'}, {up: true, right: false, down: false, left: true, name: 'L8'}, {up: true, right: true, down: true, left: true, name: 'L9'}, {up: true, right: false, down: true, left: true, name: 'L10'}, {up: false, right: true, down: true, left: false, name: 'L11'}, {up: true, right: false, down: false, left: true, name: 'L12'}, {up: true, right: false, down: false, left: false, name: 'L13'}, {up: false, right: true, down: true, left: false, name: 'L14'}],
                  // Row M
