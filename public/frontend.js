...
var maze2 = [ // Row A
              ...
              // Row L
              [{up: true, right: false, down: false, left: true, name: 'L1'}, {up: false, right: true, down: true, left: false, name: 'L2'}, {up: false, right: false, down: true, left: true, name: 'L3'}, {up: false, right: true, down: true, left: false, name: 'L4'}, {up: false, right: true, down: true, left: true, name: 'L5'}, {up: false, right: false, down: false, left: true, name: 'L6'}, {up: false, right: true, down: true, left: false, name: 'L7'}, {up: false, right: true, down: false, left: true, name: 'L8'}, {up: false, right: true, down: false, left: true, name: 'L9'}, {up: true, right: false, down: false, left: true, name: 'L10'}, {up: false, right: true, down: true, left: false, name: 'L11'}, {up: false, right: true, down: false, left: true, name: 'L12'}, {up: false, right: true, down: false, left: true, name: 'L13'}, {up: false, right: true, down: false, left: true, name: 'L14'}],
              // Row M
